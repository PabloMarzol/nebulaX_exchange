...
from trading_system.stanley_drucken import stanley_druckenmiller_agent
from trading_system.technical_analyst import technical_analyst_agent
from trading_system.charlie_munger import charlie_munger_agent
