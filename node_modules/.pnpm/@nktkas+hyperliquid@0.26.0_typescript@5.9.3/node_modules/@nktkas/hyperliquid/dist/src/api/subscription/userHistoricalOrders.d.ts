 ...
 * ```
 */
export declare function userHistoricalOrders(config: SubscriptionRequestConfig, params: DeepImmutable<UserHistoricalOrdersParameters>, listener: (data: UserHistoricalOrdersEvent) => void): Promise<Subscription>;
