...
export declare const CDepositTypes: {
 ...
 * ```
 */
export declare function cDeposit(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<CDepositParameters>, opts?: CDepositOptions): Promise<SuccessResponse>;
//# sourceMappingURL=cDeposit.d.ts.map