 ...
 * ```
 */
export declare function cancelByCloid(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<CancelByCloidParameters>, opts?: CancelByCloidOptions): Promise<CancelSuccessResponse>;
