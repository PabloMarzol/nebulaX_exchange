...
import { Address, Decimal, parser, UnsignedDecimal, UnsignedInteger } from "../_base.js";
import { FillSchema, TwapFillSchema, TwapStateSchema, TwapStatusSchema } from "../_common_schemas.js";
// -------------------- Schemas --------------------
...
export const FundingEvent = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        funding: v.pipe(v.object({
            ...
            /** Number of samples. */
            nSamples: v.pipe(v.nullable(UnsignedInteger), v.description("Number of samples.")),
...
export const LiquidationEvent = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        liquidation: v.pipe(v.object({
            ...
            lid: v.pipe(UnsignedInteger, v.description("Unique liquidation ID.")),
            /** Address of the liquidator. */
            liquidator: v.pipe(Address, v.description("Address of the liquidator.")),
            /** Address of the liquidated user. */
            liquidated_user: v.pipe(Address, v.description("Address of the liquidated user.")),
