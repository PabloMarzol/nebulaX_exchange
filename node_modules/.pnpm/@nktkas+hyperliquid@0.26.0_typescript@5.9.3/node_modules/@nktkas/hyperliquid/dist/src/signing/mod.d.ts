 ...
 * @module
 */
import { type AbstractWallet, type Signature } from "./_signTypedData.ts";
export { type AbstractEthersV5Signer, type AbstractEthersV6Signer, type AbstractViemJsonRpcAccount, type AbstractViemLocalAccount, AbstractWalletError, getWalletAddress, getWalletChainId, } from "./_signTypedData.ts";
