 ...
 * ```
 */
export declare function spotSend(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<SpotSendParameters>, opts?: SpotSendOptions): Promise<SuccessResponse>;
