 ...
 * ```
 */
export declare function reserveRequestWeight(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<ReserveRequestWeightParameters>, opts?: ReserveRequestWeightOptions): Promise<SuccessResponse>;
