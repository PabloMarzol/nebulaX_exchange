 ...
 * ```
 */
export declare function spotUser(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<SpotUserParameters>, opts?: SpotUserOptions): Promise<SuccessResponse>;
