 ...
 * ```
 */
export declare function vaultDistribute(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<VaultDistributeParameters>, opts?: VaultDistributeOptions): Promise<SuccessResponse>;
