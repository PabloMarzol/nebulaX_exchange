 ...
 * ```
 */
export declare function vaultTransfer(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<VaultTransferParameters>, opts?: VaultTransferOptions): Promise<SuccessResponse>;
