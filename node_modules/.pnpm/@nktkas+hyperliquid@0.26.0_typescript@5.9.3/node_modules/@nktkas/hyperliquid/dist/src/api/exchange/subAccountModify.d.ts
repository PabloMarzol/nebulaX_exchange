 ...
 * ```
 */
export declare function subAccountModify(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<SubAccountModifyParameters>, opts?: SubAccountModifyOptions): Promise<SuccessResponse>;
