...
export const AlignedQuoteTokenInfoResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        dailyAmountOwed: v.pipe(v.array(v.pipe(v.tuple([
            /** Date in YYYY-MM-DD format. */
            v.pipe(v.string(), v.description("Date in YYYY-MM-DD format.")),
            /** Amount owed. */
            v.pipe(UnsignedDecimal, v.description("Amount owed.")),
        ]), v.description("[date, amount] tuple."))), v.description("Daily amount owed as an array of [date, amount] tuples.")),
        /** Predicted rate. */
