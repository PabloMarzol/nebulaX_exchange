...
export declare const AlignedQuoteTokenInfoResponse: v.SchemaWithPipe<readonly [v.ObjectSchema<{
    ...
    readonly firstAlignedTime: v.SchemaWithPipe<readonly [v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.TransformAction<any, number>, v.NumberSchema<undefined>, v.IntegerAction<number, undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>, v.DescriptionAction<number, "Timestamp (in ms since epoch) when the token was first aligned.">]>;
    /** Total EVM minted supply. */
    readonly evmMintedSupply: v.SchemaWithPipe<readonly [v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.TransformAction<any, string>, v.StringSchema<undefined>, v.TrimAction, v.RegexAction<string, undefined>, v.TransformAction<string, string>]>, v.DescriptionAction<string, "Total EVM minted supply.">]>;
    /** Daily amount owed as an array of [date, amount] tuples. */
    readonly dailyAmountOwed: v.SchemaWithPipe<readonly [v.ArraySchema<v.SchemaWithPipe<readonly [v.TupleSchema<[v.SchemaWithPipe<readonly [v.StringSchema<undefined>, v.DescriptionAction<string, "Date in YYYY-MM-DD format.">]>, v.SchemaWithPipe<readonly [v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.TransformAction<any, string>, v.StringSchema<undefined>, v.TrimAction, v.RegexAction<string, undefined>, v.TransformAction<string, string>]>, v.DescriptionAction<string, "Amount owed.">]>], undefined>, v.DescriptionAction<[string, string], "[date, amount] tuple.">]>, undefined>, v.DescriptionAction<[string, string][], "Daily amount owed as an array of [date, amount] tuples.">]>;
    /** Predicted rate. */
    readonly predictedRate: v.SchemaWithPipe<readonly [v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.TransformAction<any, string>, v.StringSchema<undefined>, v.TrimAction, v.RegexAction<string, undefined>, v.TransformAction<string, string>]>, v.DescriptionAction<string, "Predicted rate.">]>;
}, undefined>, v.DescriptionAction<{
    isAligned: boolean;
