 ...
 * ```
 */
export declare function setDisplayName(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<SetDisplayNameParameters>, opts?: SetDisplayNameOptions): Promise<SuccessResponse>;
