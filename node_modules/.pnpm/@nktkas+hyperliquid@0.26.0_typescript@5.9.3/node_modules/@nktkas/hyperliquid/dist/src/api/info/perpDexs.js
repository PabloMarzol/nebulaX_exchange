...
import { Address, ISO8601WithoutTimezone, parser, UnsignedDecimal } from "../_base.js";
// -------------------- Schemas --------------------
/**
...
export const PerpDexsResponse = /* @__PURE__ */ (() => {
    ...
    v.pipe(v.object({
        ...
        deployer: v.pipe(Address, v.description("Hex address of the dex deployer.")),
        /** Hex address of the oracle updater, or null if not available. */
        oracleUpdater: v.pipe(v.nullable(Address), v.description("Hex address of the oracle updater, or null if not available.")),
        /** Hex address of the fee recipient, or null if not available. */
        feeRecipient: v.pipe(v.nullable(Address), v.description("Hex address of the fee recipient, or null if not available.")),
        ...
        deployerFeeScale: v.pipe(UnsignedDecimal, v.description("Fee scale applied to deployer fees.")),
        /** ISO 8601 timestamp (without timezone) of the last deployer fee scale change. */
        lastDeployerFeeScaleChangeTime: v.pipe(ISO8601WithoutTimezone, v.description("ISO 8601 timestamp (without timezone) of the last deployer fee scale change.")),
