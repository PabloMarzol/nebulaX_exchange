...
export const Signature = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        r: v.pipe(v.pipe(Hex, v.length(66)), v.description("First 32-byte component of ECDSA signature.")),
        /** Second 32-byte component of ECDSA signature. */
        s: v.pipe(v.pipe(Hex, v.length(66)), v.description("Second 32-byte component of ECDSA signature.")),
        /** Recovery identifier. */
