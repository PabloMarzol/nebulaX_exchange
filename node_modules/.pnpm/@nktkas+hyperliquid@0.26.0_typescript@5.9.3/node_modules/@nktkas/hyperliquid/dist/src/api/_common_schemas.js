...
import { Address, Decimal, Hex, UnsignedDecimal, UnsignedInteger } from "./_base.js";
/**
 * Time-in-force.
...
export const OrderSchema = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        /** Size. */
        sz: v.pipe(UnsignedDecimal, v.description("Size.")),
        /** Order ID. */
        oid: v.pipe(UnsignedInteger, v.description("Order ID.")),
        /** Timestamp when the order was placed (in ms since epoch). */
        timestamp: v.pipe(UnsignedInteger, v.description("Timestamp when the order was placed (in ms since epoch).")),
...
export const DetailedOrderSchema = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        v.array(v.lazy(() => DetailedOrderSchema)), v.description("Child orders associated with this order.")),
...
export const L2BookLevelSchema = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        /** Price. */
        px: v.pipe(UnsignedDecimal, v.description("Price.")),
        /** Total size. */
        sz: v.pipe(UnsignedDecimal, v.description("Total size.")),
...
export const FillSchema = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        time: v.pipe(UnsignedInteger, v.description("Timestamp when the trade occurred (in ms since epoch).")),
        /** Start position size. */
        ...
        /** Realized PnL. */
        closedPnl: v.pipe(Decimal, v.description("Realized PnL.")),
        /** L1 transaction hash. */
        ...
        fee: v.pipe(Decimal, v.description("Fee charged or rebate received (negative indicates rebate).")),
        /** Unique transaction identifier for a partial fill of an order. */
        tid: v.pipe(UnsignedInteger, v.description("Unique transaction identifier for a partial fill of an order.")),
        /** Client Order ID. */
        cloid: v.pipe(v.optional(v.pipe(Hex, v.length(34))), v.description("Client Order ID.")),
        /** Liquidation details. */
        liquidation: v.pipe(v.optional(v.object({
            /** Address of the liquidated user. */
            liquidatedUser: v.pipe(Address, v.description("Address of the liquidated user.")),
            /** Mark price at the time of liquidation. */
            markPx: v.pipe(UnsignedDecimal, v.description("Mark price at the time of liquidation.")),
            /** Liquidation method. */
...
//# sourceMappingURL=_common_schemas.js.map