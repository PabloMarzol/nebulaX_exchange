 ...
 * ```
 */
export declare function scheduleCancel(config: ExchangeRequestConfig | MultiSignRequestConfig, params?: DeepImmutable<ScheduleCancelParameters>, opts?: ScheduleCancelOptions): Promise<SuccessResponse>;
export declare function scheduleCancel(config: ExchangeRequestConfig | MultiSignRequestConfig, opts?: ScheduleCancelOptions): Promise<SuccessResponse>;
