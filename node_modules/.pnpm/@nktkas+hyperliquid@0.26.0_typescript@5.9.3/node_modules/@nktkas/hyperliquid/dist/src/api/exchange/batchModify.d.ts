 ...
 * ```
 */
export declare function batchModify(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<BatchModifyParameters>, opts?: BatchModifyOptions): Promise<OrderSuccessResponse>;
