...
import { Address, parser, Percent, UnsignedDecimal, UnsignedInteger } from "../_base.js";
import { executeL1Action, Signature, } from "./_base/mod.js";
// -------------------- Schemas --------------------
/**
        ...
        action: v.pipe(v.union([
            ...
            v.pipe(v.object({
                ...
                enableQuoteToken: v.pipe(v.object({
                    ...
                    token: v.pipe(UnsignedInteger, v.description("The token ID to convert to a quote token.")),
 ...
 * ```
 */
export async function spotDeploy(config, params, opts) {
