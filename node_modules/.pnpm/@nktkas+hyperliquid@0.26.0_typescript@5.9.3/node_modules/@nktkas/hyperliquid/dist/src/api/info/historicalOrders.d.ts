 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#retrieve-a-users-historical-orders
 */
export declare const HistoricalOrdersResponse: v.SchemaWithPipe<readonly [v.ArraySchema<v.SchemaWithPipe<readonly [v.ObjectSchema<{
    /** Order details. */
 ...
 * ```
 */
export declare function historicalOrders(config: InfoRequestConfig, params: DeepImmutable<HistoricalOrdersParameters>, signal?: AbortSignal): Promise<HistoricalOrdersResponse>;
