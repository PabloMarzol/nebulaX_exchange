...
import { PortfolioResponse } from "./portfolio.js";
// -------------------- Schemas --------------------
/**
...
export const VaultDetailsRequest = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        /** User address. */
        user: v.pipe(v.nullish(Address), v.description("User address.")),
...
export const VaultDetailsResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        portfolio: v.pipe(PortfolioResponse, v.description("Vault portfolio metrics grouped by time periods.")),
