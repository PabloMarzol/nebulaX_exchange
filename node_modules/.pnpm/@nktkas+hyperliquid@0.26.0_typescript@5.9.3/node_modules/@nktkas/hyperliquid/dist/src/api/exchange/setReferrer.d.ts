 ...
 * ```
 */
export declare function setReferrer(config: ExchangeRequestConfig | MultiSignRequestConfig, params: DeepImmutable<SetReferrerParameters>, opts?: SetReferrerOptions): Promise<SuccessResponse>;
