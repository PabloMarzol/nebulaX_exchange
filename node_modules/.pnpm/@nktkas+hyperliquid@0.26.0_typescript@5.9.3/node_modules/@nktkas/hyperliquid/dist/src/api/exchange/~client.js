...
export { ApiRequestError } from "./_base/mod.js";
/**
...
export class ExchangeClient {
    ...
    constructor(args) {
        ...
        this.wallet = typeof args.wallet === "string"
            ...
            ? new PrivateKeyEIP712Signer(args.wallet)
            : args.wallet;
...
export class MultiSignClient extends ExchangeClient {
    ...
    constructor(args) {
        ...
        const processedSigners = args.signers
            .map((signer) => typeof signer === "string" ? new PrivateKeyEIP712Signer(signer) : signer);
