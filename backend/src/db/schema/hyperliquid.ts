...
export type HyperliquidOrder = typeof hyperliquidOrders.$inferSelect;
export type NewHyperliquidOrder = typeof hyperliquidOrders.$inferInsert;

export type HyperliquidPosition = typeof hyperliquidPositions.$inferSelect;
export type NewHyperliquidPosition = typeof hyperliquidPositions.$inferInsert;

export type HyperliquidFill = typeof hyperliquidFills.$inferSelect;
export type NewHyperliquidFill = typeof hyperliquidFills.$inferInsert;

export type HyperliquidReconciliation = typeof hyperliquidReconciliations.$inferSelect;
export type NewHyperliquidReconciliation = typeof hyperliquidReconciliations.$inferInsert;

export type HyperliquidUserStateCache = typeof hyperliquidUserStateCache.$inferSelect;
export type NewHyperliquidUserStateCache = typeof hyperliquidUserStateCache.$inferInsert;
