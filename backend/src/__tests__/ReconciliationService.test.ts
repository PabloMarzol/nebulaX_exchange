...
} from '../services/hyperliquid/ReconciliationService';
import type { DiscrepancyEvent } from '../services/hyperliquid/ReconciliationService';
...
describe('ReconciliationService', () => {
  ...
  describe('Order Reconciliation', () => {
    it('should reconcile orders with no discrepancies', async () => {
      ...
      const result = await reconciliationService.reconcileUserOrders(
        testUserId,
        testUserAddress
      );
  ...
  describe('Position Reconciliation', () => {
    it('should reconcile positions with no discrepancies', async () => {
      ...
      const result = await reconciliationService.reconcileUserPositions(
        testUserId,
        testUserAddress
      );
  ...
  describe('Periodic Reconciliation', () => {
    it('should start periodic reconciliation', () => {
      ...
      reconciliationService.startPeriodicReconciliation(
        testUserId,
        testUserAddress,
    ...
    it('should run reconciliation periodically', async () => {
      ...
      reconciliationService.on('reconciliationComplete' as any, () => {
        reconciliationCount++;
      });
