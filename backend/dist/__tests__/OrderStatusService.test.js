...
import { OrderStatusService, getOrderStatusService, resetOrderStatusService, } from '../services/hyperliquid/OrderStatusService';
// Mock dependencies
...
describe('OrderStatusService', () => {
    ...
    describe('Subscription Management', () => {
        it('should subscribe to user orders', async () => {
            ...
            expect(mockClient.subscribeToUserEvents).toHaveBeenCalledWith(testUserAddress, expect.any(Function));
        ...
        it('should handle subscription errors', async () => {
            mockClient.subscribeToUserEvents.mockRejectedValueOnce(new Error('WebSocket connection failed'));
            await expect(orderStatusService.subscribeToUserOrders(testUserId, testUserAddress)).rejects.toThrow('WebSocket connection failed');
        });
    });
    describe('Unsubscription', () => {
        ...
        it('should handle unsubscribe when no subscription exists', async () => {
            ...
            await expect(orderStatusService.unsubscribeFromUserOrders('non-existent-address')).resolves.not.toThrow();
        });
        it('should handle unsubscribe errors', async () => {
            ...
            mockClient.subscribeToUserEvents.mockResolvedValue(mockSubscription);
            await orderStatusService.subscribeToUserOrders(testUserId, testUserAddress);
            await expect(orderStatusService.unsubscribeFromUserOrders(testUserAddress)).rejects.toThrow('Unsubscribe failed');
        });
    });
