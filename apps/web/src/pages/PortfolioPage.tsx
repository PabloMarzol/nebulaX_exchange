...
import { CreatePie } from '@/components/portfolio/CreatePie';
import { AIAnalysisLoading } from '@/components/portfolio/AIAnalysisLoading';
...
type TabType = 'overview' | 'analytics' | 'transactions' | 'market' | 'create-pie';
...
export function PortfolioPage() {
  ...
  const tabs = [
    ...
    { id: 'create-pie' as const, label: 'Create Pie', icon: PieChart }
  ];

  return (
    <div className="flex min-h-screen bg-[#050505]">
      {/* AI Analysis Loading Overlay */}
      <AIAnalysisLoading isAnalyzing={analysisMutation.isPending} />

      {/* Vertical Sidebar */}
      <div className="w-64 min-h-screen glass-panel border-r border-white/5 bg-black/50 p-4 fixed left-0 top-0">
        {/* Logo/Title */}
        ...
        <div className="mt-8 space-y-2 px-2">
          <Button
            ...
            className="w-full bg-white text-black hover:bg-zinc-200 shadow-[0_0_15px_rgba(255,255,255,0.1)]"
          >
          ...
          <Button
            ...
            className="w-full bg-zinc-900 border-zinc-800 text-zinc-300 hover:bg-zinc-800 hover:text-white"
          >
          ...
          <div className="mt-8 px-2">
            <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-semibold text-emerald-400">Analysis Active</span>
              </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500 mt-1">
                {activeTab === 'overview' && 'Complete portfolio overview with performance metrics'}
                {activeTab === 'analytics' && 'AI-powered trading signals and recommendations'}
                {activeTab === 'transactions' && 'View your transaction history and activity'}
                {activeTab === 'market' && 'Real-time market overview and top movers'}
                {activeTab === 'create-pie' && 'Create custom investment portfolios with your favorite coins'}
              </p>
            </div>
          </div>
              ...
              {analysisData?.decisions ? (
                ...
                <div className="border-2 border-dashed border-zinc-800 rounded-xl p-12 text-center">
                  ...
                  <p className="text-xs text-zinc-500 mb-4">
                    Click "Run AI Analysis" in the sidebar to get trading recommendations from our AI agents
                  </p>
                </div>
              )}
            </div>
